...
## 4. Evaluation evidence (release v0.2.1, run 20260913-113753, resumed from 20260913-105614: 14 documents re-checked from their hash-attested extractions, 1 (G06) extracted again, date 2026-09-13)
...
- False-flag rate on clean fields: 0/399 (equal prominence by policy).
