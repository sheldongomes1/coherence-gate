...
| 2026-09-11 | S2 FULL BASELINE run 20260911-193808: prompt extract_v1 (sha 54aedf9a8801), medium effort both, timeouts on, enum-parenthetical fix in normalizer | **8/9** (field-only 9/9) | **0/218**; clean docs auto-cleared 2/2 | 227/228 | 9/9 | $0.112 (min 0.071, max 0.160; Gemini thinking 1.2k-24k tokens/doc) | miss = G07 autocall_level_pct: BOTH families wrote the step-down as a JSON array inside the string value ('["100 per cent.", ...]'); normalizer rejected -> MALFORMED (caught field-only, wrong type). trap G09 CLEAN 1/1 |
