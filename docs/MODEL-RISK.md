...
> **TEMPLATE.** The user-supplied shape, kept verbatim. The filled, current document is the root
> `MODEL-RISK.md`, generated by `scripts/fill_model_risk.py <run> <version>` at each release; edit
> that script or this template, never the generated file.
